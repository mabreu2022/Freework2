...
uses
  ...
  Interfaces.ContasaReceber in 'Interfaces\Interfaces.ContasaReceber.pas',
  View.ContasaPagar in 'View\View.ContasaPagar.pas' {FrmContasaPagar},
  Model.ContasaPagar in 'Model\Model.ContasaPagar.pas',
  Interfaces.ContasaPagar in 'Interfaces\Interfaces.ContasaPagar.pas';
